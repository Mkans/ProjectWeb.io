				...
				<?php elseif ('radio' == $option['type']): ?>
					...
					<div data-input-id="<?php echo esc_attr($option['id']); ?>" class="tfb_lb_option_child tf-radio-choice">
						<?php foreach ($option['options'] as $k => $v): ?>
							...
							<input <?php if(!empty($v['disable'])):?>disabled="disabled"<?php endif;?> id="<?php echo esc_attr($option['id'] . '_' . $k); ?>" type="radio" name="<?php echo esc_attr($option['id']); ?>" class="themify-builder-radio-dnd <?php echo $option_js; ?>" value="<?php echo esc_attr($k); ?>" <?php echo " $checked $data_el"; ?>/>
						...
						<?php elseif ('radio' == $field['type']): ?>
							...
							<div id="<?php echo esc_attr($field['id']); ?>" class="tfb_lb_option tf-radio-input-container <?php echo esc_attr($option_js_wrap); ?>">
								<?php foreach ($field['options'] as $k => $v): ?>
									...
									?>
									<input <?php if(!empty($v['disable'])):?>disabled="disabled"<?php endif;?> id="<?php echo esc_attr($field['id'] . '_' . $k); ?>" name="<?php echo esc_attr($field['id']); ?>" type="radio" class="<?php echo $option_js; ?>" value="<?php echo esc_attr($k); ?>" <?php echo " $default_checked $data_el"; ?>/>
			...
			case 'select':
				...
				<select id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>" class="tfb_lb_option <?php echo isset($styling['class']) ? esc_attr($styling['class']) : ''; ?>" <?php echo themify_builder_get_binding_data($styling); ?>>
					...
					foreach ($styling['meta'] as $option):
						?>
						<option <?php if(!empty($option['disable'])):?>disabled="disabled"<?php endif;?> value="<?php echo esc_attr($option['value']); ?>"><?php echo esc_html($option['name']); ?></option>
					<?php endforeach; ?>
				...
				<div id="<?php echo esc_attr($styling['id']); ?>" class="tfb_lb_option tf-radio-input-container <?php echo esc_attr($option_js_wrap); ?>">
					...
					foreach ($styling['meta'] as $k=>$option) {
						...
						$checked = !$checked && isset($styling['default']) && $styling['default'] == $k ? 'checked="checked"' : $checked;
                                                ?>
						<input <?php if(!empty($option['disable'])):?>disabled="disabled"<?php endif;?> type="radio" id="<?php echo esc_attr($styling['id'] . '_' . $option['value']); ?>" name="<?php echo esc_attr($styling['id']); ?>" value="<?php echo esc_attr($option['value']); ?>" class="tfb_lb_option <?php echo $option_js; ?>" <?php echo $checked . ' ' . $data_el; ?>> <label for="<?php echo esc_attr($styling['id'] . '_' . $option['value']); ?>"><?php echo esc_html($option['name']); ?></label>
						<?php
					}
					?>
					<?php
