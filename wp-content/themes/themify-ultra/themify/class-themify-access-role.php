	...
	class Themify_Access_Role {
		...
		function config_view( $data = array() ){
		    ...
		    if ( 'custom_panel' == $setting ) :
			    ?>
			    <div class="themify-info-link">Role access allow certain user roles to have access to the tool. Only set disable if you want to disallow the tool to certain user(s), otherwise keep everything as default.</div>
			    <?php
		    endif;
		    ?>
		    <ul>
